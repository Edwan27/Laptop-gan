...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{url ('/template/css/templatemo-style.css') }}">
</head>
<!--
...
<body> 
	...
	<!-- Top box -->
		<!-- Logo & Site Name -->
			...
			<div class="parallax-window" data-parallax="">
            <img src="/template/img/laptop1.jpg" width="1200 px" height="500 px">
				<div class="tm-header">
					<div class="row tm-header-inner">
						...
						<nav class="col-md-6 col-12 tm-nav">
							<ul class="tm-nav-ul">
                                ...
                                <li class="tm-nav-li"><a href="#" class="tm-nav-link">Login</a></li>
							</ul>
						</nav>	
					</div>
				</div>
